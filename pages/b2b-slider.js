...
<div className='item'>
                                    ...
                                    <div className='item'>
                                        <img src='./assests/clients/B7.webp' alt='Retrieving data. Wait a few seconds and try to cut or copy again.' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
                                        <img src='./assests/clients/B8.webp' alt='SEO Client IDC Logo' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
