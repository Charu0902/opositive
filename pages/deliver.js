...
<section className="banner-deliver">
          ...
          <div className="row">
            ...
            <div className="col-lg-7">
              <div className="row reserchlab">
                <div className="col-lg-6">
                  <a href="/">
                    <img src="./assests/logo-white.webp"  className ="img-fluid"/>
                  </a>
                  <h1>RESERARCH LAB</h1>
                </div>
            ...
            <div className="col-lg-2 white-arrow">
              <button type="button" onClick={topFunction}>
                <img src="./assests/arrow-bottom.png" />
              </button>
            </div>
          </div>
        </div>
      ...
      <section className="pillars">
        ...
        playsinline ={"true"}
          ...
          preLoad={"metadata"}
        playsinline ={"true"}
          loop  id='desktop-video' poster='./assests/circularellipse.png'>
               <source src="./assests/pillars-growth.mp4"  />
           </video>
      </section>
            ...
            <div className="col-lg-6 col-12">
              ...
              >
                <div className="tabcontent-imgdiv">
                  <img src="./assests/curiosity.png"  className ="img-fluid"/>
                  {/* <img src="./Assets/ellipseicon1.png" className="icon-tab img-fluid" /> */}
                </div>
              ...
              <div className="tab-content" id="Infinite">
                <div className="tabcontent-imgdiv">
                  <img src="./assests/intent.png"  className ="img-fluid"/>
                  {/* <img src="./Assets/ellipseicon2.png" className="icon-tab img-fluid" /> */}
                </div>
                <p className="tab-para">
              ...
              <div className="tab-content" id="Quarter">
                <div className="tabcontent-imgdiv">
                  <img src="./assests/quarter.png" className ="img-fluid" />
                  {/* <img src="./Assets/ellipseicon3.png" className="icon-tab img-fluid" /> */}
                </div>
                <p className="tab-para">
              ...
              <div className="tab-content" id="Realtime">
                <div className="tabcontent-imgdiv">
                  <img src="./assests/realtime.png" className ="img-fluid"/>
                  {/* <img src="./Assets/ellipseicon4.png" className="icon-tab img-fluid" /> */}
                </div>
                <p className="tab-para">
              ...
              <div className="tab-content" id="Quality">
                <div className="tabcontent-imgdiv">
                  <img src="./assests/quality.png" className ="img-fluid"/>
                  {/* <img src="./Assets/5ellipse.png" className="icon-tab img-fluid" /> */}
                </div>
                <p className="tab-para">
              ...
              <div className="tab-content" id="Experimentation">
                <div className="tabcontent-imgdiv">
                  <img src="./assests/experimental.png" className ="img-fluid"/>
                  {/* <img src="./Assets/6ellipse.png" className="icon-tab img-fluid" /> */}
                </div>
                <p className="tab-para">
         ...
         <Deliverslider></Deliverslider>
          <div className="row casestudies-row blogs-row ">
            ...
            <Link href='/case-study/gourmet-garden'>
              <img src="./assests/casestudy1.jpg" className ="img-fluid case-study-img" />
              </Link>
            </div>
            <div className="col-lg-3 col-6 case-studyimg-box">
              <img src="./assests/casestudy2.jpg" className ="img-fluid case-study-img"/>
            </div>
            <div className="col-lg-3 col-6 case-studyimg-box">
              <img src="./assests/casestudy3.jpg" className ="img-fluid case-study-img"/>
            </div>
            <div className="col-lg-3 col-6 case-studyimg-box">
              <img src="./assests/casestudy4.jpg" className ="img-fluid case-study-img"/>
            </div>
          </div>
