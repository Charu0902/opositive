...
const Careers = () =>{
 ...
 <meta charSet="utf-8" />
                ...
                <meta property="og:image" content="https://opositive.io/assests/thumbnail-careers.webp"/> 
                ...
                <meta property="twitter:image" content=" https://opositive.io/assests/thumbnail-careers.webp"/> 
        </Head>
        ...
        <video
          ...
          loop
          id="mobile-video"
          poster="./assests/thumbnail-careers.webp"
          style={{ width: "100%" }}
        >
        ...
        <video
          ...
          loop
          id="desktop-video"
          poster="./assests/careers-banner.webp"
          style={{ width: "100%" }}
        >
          <source src="./assests/careers-banner.mp4" />
        </video>
      </section>
        ...
        <div className="container">
          ...
          <div class="tab-content" id="pills-tabContent">
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12">
                  <video
                    ...
                    playsinline={"true"}
                    loop
                    poster="./assests/seothumb.png"
                  >
                    <source src="./assests/seogif.mp4" />
                  </video>
                </div>
                <div className="col-md-6 col-sm-12">
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12">
                  <video
                    ...
                    playsinline={"true"}
                    loop
                    poster="./assests/cofounderthumb.png"
                  >
                    <source src="./assests/GIF (1).mp4" />
                  </video>
                </div>
                <div className="col-md-6 col-sm-12">
            ...
            >
              <div className="row">
                <div className="col-md-6 col-sm-12">
                  <img src="./assests/Global Experts.jpg" className="img-fluid"/>
                </div>
                <div className="col-md-6 col-sm-12">
              ...
              <div className="row">
                <div className="col-md-6 col-sm-12">
                  <video
                    ...
                    playsinline={"true"}
                    loop
                    poster="./assests/fridaythumb.png"
                  >
                    <source src="./assests/friday.mp4" />
                  </video>
                </div>
                <div className="col-md-6 col-sm-12">
                  <h3>3 pm fridays</h3>
      ...
      <section className="life">
        <div className="container">
          ...
          <video
            ...
            className="lifevideo"
            loop
            poster="./assests/career.webp"
          >
            <source src="./assests/career.mp4" />
          </video>
        </div>
      </section>
            ...
            <div className="col-md-6 col-sm-12">
              ...
              <a href="#expore-opportunities">
                <button className="more-btn workbutton">
                  WORK WITH O+
                  <img
                    src="./assests/Arrow (2).png"
                    alt=""
                    className="red-arrow img-fluid "
                  />
                </button>
              </a>
            </div>
            <div className="col-md-6 col-sm-12">
              <img src="./assests/brandsimg.png" className="img-fluid brands-img" />
            </div>
          </div>
        </div>
      </section>
