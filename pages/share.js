...
const Share = () =>{
 ...
 <Head>
 <meta charSet="utf-8" />
                <title>Collaborate and exchange ideas. Bring your concept to reality with O+</title>
                ...
                <meta property="og:image" content="https://opositive.io/assests/new-thumbnail.webp"/> 
                ...
                <meta property="twitter:image" content=" https://opositive.io/assests/new-thumbnail.webp"/> 
        </Head>       
        <section className="banner-deliver">
          ...
          preLoad={"metadata"}
        playsinline ={"true"}
          loop id='mobile-video' poster='./assests/new-thumbnail.webp'>
               <source src="./assests/O+ banner Video (680x580).mp4"  />
           </video>
           <video
          muted
          autoPlay={"autoplay"}
          preLoad={"metadata"}
        playsinline ={"true"}
          loop id='desktop-video' poster='./assests/share-banner.webp'>
               <source src="./assests/share-banner Video - 1440x680.mp4"  />
           </video> 
      </section>    
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-3 col-3 share-steps-col">
                        <img src="./assests/grow_share.png" className ="img-fluid"/> 
                        <h3>Grow</h3>                
                           </div>
                    <div className="col-md-3 col-3 share-steps-col">
                    <img src="./assests/engage_share.png" className ="img-fluid"/>                 
                       <h3>Engage</h3>
                    </div>
                    <div className="col-md-3 col-3 share-steps-col">
                    <img src="./assests/contribute_share.png" className ="img-fluid"/>                 
                       <h3>Contribute</h3>
                    </div>
              ...
              <div className="col-md-10 col-12 grow-black-background">
                  ...
                  <div className="row">
                    ...
                    <h2 className="grow-name-heading">Fostering Experiential Learning</h2>
                      <div className="col-md-4 col-12">
                      <img src="./assests/Grow Section GIF.webp" className ="img-fluid grow-img"/>                 
...
With guidance from industry and global experts who are associated with the O+ Research Lab, it is a one-of-a-kind educational experience for everyone who is curious to know more about the digital world. 
                        ...
                        <Link href='/master-class'><button className='more-btn btn-red-text'>GROW WITH THE O+ MASTERCLASS<img src='./assests/Arrow (2).png' alt='' className='red-arrow img-fluid '/></button>
                      </Link>
                      </div>
                  </div>
                  </div>
             ...
             <div className="col-md-10 col-12 engage-grey-background">
                  ...
                  <div className="row">
                    ...
                    <h2 className="engage-name-heading">Find Answers to your Digital Curiosities  
                      ...
                      <div className="col-md-4 col-12">
                      <img src="./assests/Prism-GIF---(300x300px).gif" className ="img-fluid engage-img"/>                 
...
Tell us what you want to know more of, and it shall be conjured.  
                        ...
                        <a href='https://opositive.io/blog/'><button className='more-btn btn-red-text'>ASK US WHAT INTRIGUES YOU<img src='./assests/Arrow (2).png' alt='' className='red-arrow img-fluid '/></button>
                      </a>
                      </div>
                  </div>
                  </div>
              ...
              <div className="col-md-10 col-12 contribute-black-background">
                  ...
                  <div className="row">
                    ...
                    <h2 className="contribute-name-heading">Welcoming Expert Insights 
                      ...
                      <div className="col-md-4 col-12">
                      <img src="./assests/Box Animation - GIF.webp" className ="img-fluid contribute-img"/>                 
...
Use the O+ platform to resonate your voice with thousands of digital enthusiasts looking for direction. Let’s break the barriers together.  
                        ...
                        <Link href='/contribute'><button className='more-btn btn-red-text'>HELP ENLIGHTEN OUR COMMUNITY <img src='./assests/Arrow (2).png' alt='' className='red-arrow img-fluid '/></button>
                      </Link>
                      </div>
                  </div>
                  </div>
