...
>
<div className='item'>
                                        <img src='./assests/clients/D1.webp' alt='E-commerce SEO Client NOVO' className='img-fluid desktop-client-img lazy ' />
                                    </div>
                                    <div className='item'>
                                        <img src='./assests/clients/D2.webp' alt='SEO Client DAILYOBJECTS Logo ' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
                                        <img src='./assests/clients/D3.webp' alt='SEO Client Trainmain Logo ' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
                                        <img src='./assests/clients/D4.webp' alt='SEO Client TESCO Logo' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
                                        <img src='./assests/clients/D5.webp' alt='SEO Client Jaipur Rugs Logo' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
                                        <img src='./assests/clients/D6.webp' alt='SEO Client DA MILANO Logo' className='img-fluid desktop-client-img lazy' />
                                    </div>
                                    <div className='item'>
