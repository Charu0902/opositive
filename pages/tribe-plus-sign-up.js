...
const Tribe = () => {
    return (
        ...
        <Head>
                ...
                <meta property="og:image" content="https://opositive.io/assests/og-tribe.webp"/> 
                ...
                <meta property="twitter:image" content=" https://opositive.io/assests/og-tribe.webp"/> 
            </Head>
        ...
        playsinline ={"true"}
          loop className="studio-video" poster='./assests/Tribe Thumbnail.webp'>
               <source src="./assests/Tribe-plus.mp4"  />
                ...
                <div className="col-md-6 col-12">
                <h1 className="master-class-heading studioheading mobile">Revolutionize backlinking with Tribe+  </h1>
                <Tribeform></Tribeform>
                </div>
