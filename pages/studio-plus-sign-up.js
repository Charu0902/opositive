    ...
    return (
        <>
         <Head>
                ...
                <meta property="og:image" content="https://opositive.io/assests/og-studio.webp"/> 
                ...
                <meta property="twitter:image" content=" https://opositive.io/assests/og-studio.webp"/> 
            </Head>
        <section className="master-class">
          ...
          preLoad={"metadata"}
        playsinline ={"true"}
          loop className="studio-video" poster='./assests/Studi + Thumbnail.webp'>
               <source src="./assests/studi-gif.mp4"  />
           </video> 
                </div>
                <div className="col-md-6 col-12">
