...
<div className="item">
              <div className="row testimonialrow">
                ...
                <div className="col-md-4 col-sm-12 testimoinal-col">
                  <img src="./assests/Preksha.png" className="img-fluid" />
                </div>
              </div>
            </div>
            <div className="item">
              <div className="row testimonialrow">
                ...
                <div className="col-md-4 col-sm-12 testimoinal-col">
                  <img src="./assests/Kanisha.png" className="img-fluid" />
                </div>
              </div>
            </div>
            <div className="item">
              <div className="row testimonialrow">
                ...
                <div className="col-md-4 col-sm-12 testimoinal-col">
                  <img src="./assests/Ajay.png" className="img-fluid" />
                </div>
              </div>
            </div>
            <div className="item">
              <div className="row testimonialrow">
                ...
                <div className="col-md-4 col-sm-12 testimoinal-col">
                  <img src="./assests/Dushank.png" className="img-fluid" />
                </div>
              </div>
            </div>
</Carousel>
